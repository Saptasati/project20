...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    ...
    var cash = createSprite(width-30,40, 10, 10);
    cash.x = Math.round(random(width,350))
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(width-900,40, 10, 10);
    diamonds.x = Math.round(random(width,350))
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(width-600,40, 10, 10);
    jwellery.x = Math.round(random(width,350))
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(width-40,40, 10, 10);
    sword.x = Math.round(random(width,350))
